...
// const names = [
//     { firstName: "Aldo", lastName: "Ademi" },
//     { firstName: "Marco", lastName: "Togni" },
//     { firstName: "Piero", lastName: "Giallo" },
//     { firstName: "Giorgia", lastName: "Meloni" },
//     { firstName: "Fabrizio", lastName: "Corona" },
//     { firstName: "Nicolo", lastName: "Fagioli" }
// ];
...
//     const electoral_card_number = `BB${index}`;
...
//         promises.push(sendSingleElection(signer, programId, connection, i, pda_candidate_list,pda_election, randomName.firstName, randomName.lastName));
//     }
...
const TOTAL_TRANSACTIONS = 500; // Numero totale di transazioni da inviare
...
async function sendSingleElection(
    ...
    let buffer = Buffer.alloc(1000);
    const electoral_card_number = `LP${index}`;
