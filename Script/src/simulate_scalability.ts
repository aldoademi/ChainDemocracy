...
//     let buffer = Buffer.alloc(1000);
//     const electoral_card_number = `AH${index}`;
//     const first_name = 'Giorgia';
//     const last_name = 'Meloni';
//     const election_name = 'Elettorale1';
//     const seed = 'candidate-list';
//     electionInstructionLayout.encode(
//         {
...
//     const signer = initializeSignerKeypair();
//     const chainDemocracyProgramId = new web3.PublicKey('EKYK5zwJtEgshw3isbkRrvEKCRuoTqN7ZNqNme5P2A6X');
